...
### Training
- Pertemuan 1 : [OpenCV - Basic Image Processing](Pertemuan%201/)
...
- Pertemuan 2 : [Intro Object Detection & Object Detection Inferencing](Pertemuan%202/)
	- Intro Object Detection
	- Intro to YOLO V8 Ultralytics & PyTorch Model
	- Into to OpenCV DNN
	- Inferencing Yolo V8 Object Detection in OpenCV DNN
- Pertemuan 3 : [Training Model Yolo V8 using Ultralytics & Custom Dataset](Pertemuan%203/)
...
- Pertemuan 4 : [Auto Annotation using Autodistill + Grounding DINO](Pertemuan%204/)
...
- Pertemuan 5 : [Object Counting using OpenCV DNN vs Supervision](Pertemuan%205/)
...
- Pertemuan 6 : [Yolo V8 Model Optimization](Pertemuan%206/)
